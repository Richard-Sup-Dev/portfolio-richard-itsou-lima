...
export default function Projects() {
  return (
    <section id="projects" className="container mx-auto px-4 py-20">
      ...
      >
        {/* Imagem do projeto com efeito de vidro e brilho especial */}
        <motion.div
        ...
        {/* Aqui ficam a descrição, as tecnologias usadas e os links do projeto */}
        <motion.div
        ...
        >
          ...
          <div className="flex gap-6 mt-2">
            ...
            {/* Caso queira mostrar o link para o site ao vivo, é só descomentar abaixo */}
            {/* {dashborn.liveUrl && (
              <a
